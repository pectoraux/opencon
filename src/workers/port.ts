/**
 * Workers boundary — declared public interface (port).
 *
 * Architecture ref: spec/architecture.md §18 (Module ownership).
 * Authority: asynchronous execution only; not authoritative state.
 *
